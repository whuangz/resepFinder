...
class RFTabBarVC: UITabBarController {
    ...
    fileprivate func setupTabBarMenuItems(){
        ...
        let createRecipe = self.setTabBarItem(UIViewController(), imageName: "createR", selectedImg: "selected_createR", tag: 2, title: RFLocalizedString().forKey("create_tab_menu"))
